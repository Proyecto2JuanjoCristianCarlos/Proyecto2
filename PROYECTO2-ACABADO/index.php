		...
		<div class="modalbox movedown" id="resultadoContent">
			...
			<form name="formlogin" action="checklogin.php" method="POST">
				...
				<div class="central" id="contenidoResultado">
					...
					<input type="text" name="usuario" placeholder="Introduce nombre de usuario" required=""/><br /><br />				
					<b>Contraseña</b><br />
					<div class="error">
					<?php
					...
					<input type="password" placeholder="Introduce la contraseña" name="pwd" required="" /> <br /><br />
